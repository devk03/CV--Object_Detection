...
while cap.isOpened():
    ...
    for c in cnts:
        ...
        if (area > 500):
            ...
            # detects triangle
            if(ratio>0.14433756729-triangle_slack and ratio < 0.14433756729+triangle_slack and sides == 3):
            ...
            elif (ratio>0.25-square_slack and ratio < 0.25+square_slack and sides == 4):
